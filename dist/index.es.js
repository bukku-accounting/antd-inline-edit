...
function InlineEditDisplay(_ref) {
  ...
  if (displayRenderer) {
    ...
    if (displayRenderer.length === 1 && !label) {
      displayDOM = /*#__PURE__*/React__default.createElement(DisplayPlaceholder, {
        onClick: onClick,
...
function InlineEditInputFactory(_ref) {
  ...
  if (component === 'textarea') {
    ...
    }, /*#__PURE__*/React__default.createElement(Input.TextArea, _extends({}, commonProps, parsedTextAreaProps)), /*#__PURE__*/React__default.createElement(InputSuffix, {
      component: "textarea",
      isChanged: isChanged,
      onUndoClick: onUndoClick,
      onSaveClick: onInputSave
