...
var UndoOutlined$1 = /*#__PURE__*/React__namespace.forwardRef(UndoOutlined);

var Globals = {
  DEFAULT_PLACEHOLDER: 'Click to edit',
  DEFAULT_UNDO_TOOLTIP_TEXT: 'Undo',
  DEFAULT_UNDO_ICON: /*#__PURE__*/React.createElement(UndoOutlined$1, null),
...
function InlineEditDisplay(_ref) {
  ...
  return /*#__PURE__*/React.createElement(DisplayPlaceholder, {
    onClick: onClick,
...
function InputSuffix(_ref) {
  ...
  var renderIcon = function renderIcon() {
    if (icon) {
      ...
      return /*#__PURE__*/React.cloneElement(icon, _objectSpread2$1(_objectSpread2$1({}, commonProps), {}, {
    ...
    }, /*#__PURE__*/React.createElement(UndoOutlined$1, _extends({
      id: "inline-edit__undo-button"
    }, commonProps)));
  };
  return renderIcon();
...
function InlineEditInputFactory(_ref) {
  ...
  var inputProps = {
    ...
    suffix: /*#__PURE__*/React.createElement(InputSuffix, {
      isChanged: isChanged,
  ...
  return /*#__PURE__*/React.createElement(antd.Input, _extends({}, commonProps, inputProps));
}
...
function InlineEdit(_ref) {
  ...
  var editDOM = /*#__PURE__*/React.createElement("div", {
    className: "inline-edit__input-wrapper"
  }, /*#__PURE__*/React.createElement(InlineEditInputFactory, {
    label: label,
  ...
  return /*#__PURE__*/React.createElement(StyleWrapper, null, isEditing ? editDOM : displayDOM);
}
